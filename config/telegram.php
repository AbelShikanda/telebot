...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'               => env('APP_NAME', 'YOUR-BOT-TOKEN'),
            'token'               => env('TELEGRAM_BOT_TOKEN', '6496982679:AAELMYScxqkTvEFQaBjy5Ml1wULPF2lbYT8'),
    ...
    'chat_ids' => [
        env('TELEGRAM_CHAT_ID', '-1285112886'),
        env('TELEGRAM_CHAT_ID', '-532444837'),
